      ...
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-end">
        <div className="flex items-end gap-1">
          <button
            ...
            className="flex h-11 w-9 shrink-0 items-center justify-center rounded-lg border border-border text-muted-foreground transition-colors hover:bg-muted"
            ...
            <div key={dish.id} className="animate-fade-in-up" style={staggerStyle(i)}>
              <Card className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-role-accent-soft text-role-accent">
                    <UtensilsCrossed className="h-4.5 w-4.5" size={18} />
                  </span>
                  <div>
                    <p className="font-medium text-foreground">{dish.name}</p>
                    <div className="mt-1 flex flex-wrap gap-1">
                      {dish.allergens.length === 0 && <span className="text-xs text-muted-foreground">Aucun allergène déclaré</span>}
