...
export default function AllergySelect({ selectedIds, onChange }) {
  ...
  return <AllergenCheckboxes allergens={data.allergens} selectedIds={selectedIds} onChange={onChange} />;
}
